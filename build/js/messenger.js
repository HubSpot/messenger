// Version 1.0.9
// Built On Thu Feb 28 23:19:52 EST 2013
...
(function() {
  ...
  Message = (function(_super) {
    ...
    Message.prototype.checkClickable = function() {
      var evt, name, _ref, _ref1, _results;
      _ref = this.events;
      _results = [];
      for (name in _ref) {
        evt = _ref[name];
        if (name === 'click') {
          _results.push((_ref1 = this.$messenger) != null ? _ref1.addClass('messenger-clickable') : void 0);
        } else {
