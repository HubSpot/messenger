(function() {
  ...
  Message = (function() {
    ...
    Message.prototype.update = function(opts) {
      ...
      if (this.options.hideAfter) {
        ...
        this._hideTimeout = setTimeout(__bind(function() {
          return this.hide();
        }, this), this.options.hideAfter * 1000);
      }
      if (this.options.hideOnNavigate) {
        if (Backbone.history != null) {
          return Backbone.history.on('route', __bind(function() {
            return this.hide();
          }, this));
        }
      }
    ...
    Message.prototype.checkClickable = function() {
      ...
      for (name in _ref) {
        evt = _ref[name];
        _results.push(name === 'click' ? this.$el.addClass('messenger-clickable') : void 0);
      }
      return _results;
    };
    ...
    Message.prototype.parseActions = function() {
      var act, actions, n_act, name, _ref, _ref2, _ref3;
      actions = [];
      _ref2 = (_ref = this.options.actions) != null ? _ref : [];
      for (name in _ref2) {
        act = _ref2[name];
        n_act = $.extend({}, act);
        n_act.name = name;
  ...
  MagicMessage = (function() {
    __extends(MagicMessage, Message);
    ...
    MagicMessage.prototype.render = function() {
      ...
      for (name in _ref) {
        action = _ref[name];
        _results.push(action.auto ? this.startCountdown(name, action) : void 0);
      }
      return _results;
    };
    ...
    MagicMessage.prototype.startCountdown = function(name, action) {
      ...
      tick = __bind(function() {
        ...
        if (remaining > 0) {
          return this._timers[name] = setTimeout(tick, 1000);
        } else {
  ...
  Messenger = (function() {
    __extends(Messenger, Backbone.View);
    function Messenger() {
  ...
  ActionMessenger = (function() {
    __extends(ActionMessenger, Messenger);
    function ActionMessenger() {
      ActionMessenger.__super__.constructor.apply(this, arguments);
    }
    ...
    ActionMessenger.prototype.hookBackboneAjax = function(msgr_opts) {
      ...
      _ajax = __bind(function(opts) {
        if ($('html').hasClass('ie9-and-less')) {
          opts.cache = false;
        }
        return this["do"](msgr_opts, opts);
      }, this);
    ...
    ActionMessenger.prototype["do"] = function() {
      var args, events, m, m_opts, msg, opts, _i, _len, _ref, _ref2;
      ...
      _.each(['error', 'success'], __bind(function(type) {
        var old, _ref3;
        old = (_ref3 = opts[type]) != null ? _ref3 : function() {};
        return opts[type] = __bind(function() {
          var data, msgOpts, msgText, r, reason, resp, xhr, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
          resp = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
          _ref4 = this._normalizeResponse.apply(this, resp), reason = _ref4[0], data = _ref4[1], xhr = _ref4[2];
          if (type === 'success' && !(msg.errorCount != null) && m_opts.showSuccessWithoutError === false) {
            m_opts['successMessage'] = null;
          }
          if (type === 'error') {
            if ((_ref5 = msg.errorCount) == null) {
              msg.errorCount = 0;
            }
            msg.errorCount += 1;
          }
          msgText = this._getMessage(r = old.apply(null, resp), m_opts[type + 'Message']);
          ...
          if (msgText) {
            ...
            if (type === 'error' && (xhr != null ? xhr.status : void 0) >= 500) {
              if ((_ref7 = msgOpts.retry) != null ? _ref7.allow : void 0) {
                if (msgOpts.hideAfter) {
                  msgOpts.hideAfter += (_ref8 = msgOpts.retry.delay) != null ? _ref8 : 10;
                }
                ...
                msgOpts.actions = {
                  retry: {
                    ...
                    delay: (_ref9 = msgOpts.retry.delay) != null ? _ref9 : 10,
                    action: __bind(function() {
                      var _ref10;
                      msgOpts.messageInstance = msg;
                      msgOpts.retry.delay = ((_ref10 = msgOpts.retry.delay) != null ? _ref10 : 10) * 2;
                      return this["do"].apply(this, [msgOpts, opts].concat(__slice.call(args)));
                    }, this)
                  },
                  cancel: {
                    action: __bind(function() {
